  ...
  const tips = [
    {
      ...
      title: "효과 탐색",
      content:
        "라이브러리에서 효과를 클릭하여 선택하고, 검색 기능을 사용하여 원하는 효과를 빠르게 찾을 수 있습니다.",
    },
    {
      icon: <Lightbulb size={20} />,
      title: "파라미터 조정",
      content:
        "컨트롤 패널에서 슬라이더와 컬러 피커를 사용하여 효과의 파라미터를 실시간으로 조정할 수 있습니다.",
    },
    {
      icon: <Lightbulb size={20} />,
      title: "3D 뷰 조작",
      content:
        "마우스로 드래그하여 카메라를 회전하고, 스크롤로 확대/축소할 수 있습니다.",
    },
    {
      icon: <Lightbulb size={20} />,
      title: "프리셋 저장",
      content:
        "컨트롤 패널의 저장 버튼을 클릭하여 현재 설정을 프리셋으로 저장할 수 있습니다.",
    },
    {
      icon: <Lightbulb size={20} />,
      title: "즐겨찾기",
      content:
        "효과 카드의 별 아이콘을 클릭하여 즐겨찾기에 추가하거나 제거할 수 있습니다.",
    },
  ];
            ...
            <div className="flex-1 overflow-y-auto space-y-lg">
              ...
              <section>
                <div className="p-md bg-secondary-bg rounded border border-border-primary">
                  <h4 className="font-bold text-text-primary mb-sm">
                    프로젝트 정보
                  </h4>
                  <p className="text-sm text-text-secondary">
                    Kirakira는 건담 시리즈의 시각 효과를 Three.js로 구현한
                    인터랙티브 웹 애플리케이션입니다. 다양한 효과를 탐색하고
                    파라미터를 조정하여 나만의 효과를 만들어보세요.
                  </p>
                </div>
              </section>
            </div>
